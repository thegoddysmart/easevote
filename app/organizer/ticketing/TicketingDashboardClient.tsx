...
export default function TicketingDashboardClient({ 
  initialEvents,
  stats 
}: { 
  initialEvents: Event[],
  stats: { totalRevenue: number, ticketsSold: number, activeEvents: number }
}) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500">Manage your ticket sales and view performance.</p>
        </div>
        <button
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900">{stats.ticketsSold.toLocaleString()}</h3>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        ...
        {events.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-slate-900 mb-2">No ticketing events found</h3>
            <p className="text-slate-500 mb-6 max-w-md mx-auto">You haven't created any ticketing events yet.</p>
            <button
              onClick={() => router.push("/organizer/events/new")}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-3 flex items-center gap-6 text-sm">
                        ...
                        <div className="flex items-center gap-1.5 text-slate-600">
                          ...
                          <span className="font-medium">{event.transactionsCount}</span>
