  ...
  return (
    <section className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
      <div className="w-full rounded-3xl overflow-hidden relative min-h-[240px] flex flex-col items-center justify-center text-center">
        {/* Abstract Background */}
        <div className="absolute inset-0 bg-linear-to-r from-primary-200 via-primary-200 to-primary-200 opacity-60 z-0"></div>
        ...
        <div className="absolute bottom-0 right-0 w-64 h-64 bg-primary-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 translate-x-1/2 translate-y-1/2"></div>
        ...
        <div className="relative z-10 flex flex-col items-center gap-4">
          ...
          <nav className="flex items-center space-x-2 text-sm text-gray-600 bg-white/50 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/20 shadow-sm">
            ...
            <span className="text-primary-500 font-medium">Contact Us</span>
          </nav>
        </div>
      </div>
    </section>
