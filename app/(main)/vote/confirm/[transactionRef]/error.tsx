...
export default function VoteConfirmError({
  error,
  reset,
}: {
      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm">
            We couldn&apos;t confirm your vote. If payment was deducted, your vote was likely counted. Contact support if you need confirmation.
          </p>
        </div>
