...
export default function Newsletter() {
  return (
    <section className="relative pt-20 pb-20">
      ...
      {/* Bottom half matches the next section (Footer - primary-900) */}
      <div className="absolute bottom-0 left-0 w-full h-1/2 bg-primary-900 z-0"></div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        <div className="bg-brand-bright rounded-[3rem] p-8 md:p-16 text-center text-white relative overflow-hidden shadow-2xl shadow-black/25">
          ...
          <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 bg-primary-900 opacity-20 rounded-full blur-3xl pointer-events-none"></div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <div className="relative w-full sm:w-96">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-6 py-4 rounded-full bg-white text-brand-bright placeholder-primary-900/40 font-medium focus:outline-none focus:ring-4 focus:ring-primary-900/20 shadow-sm"
                />
              </div>
