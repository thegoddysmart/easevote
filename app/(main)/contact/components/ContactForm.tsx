    ...
    <div className="bg-white rounded-[2rem] p-8 md:p-10 shadow-xl shadow-gray-200/50 border border-gray-100">
      ...
      <form className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <select className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-gray-50 focus:bg-white transition-all">
        ...
        <button className="w-full bg-primary-700 text-white py-4 rounded-xl font-bold text-lg hover:bg-primary-900 transition-all hover:shadow-lg hover:shadow-primary-900/20 flex items-center justify-center gap-2 group">
          Send Message{" "}
          <Send
            size={20}
