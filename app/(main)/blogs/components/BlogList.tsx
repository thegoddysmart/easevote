    ...
    return (
      <div className="bg-gray-50 min-h-screen pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-[3rem] p-20 text-center border border-slate-200 shadow-xl shadow-slate-200/50 bg-white">
            ...
            >
              ...
              >
                <div>
                  ...
                  <h2
                    className={clsx(
                      "font-black text-slate-900 leading-none mb-6 tracking-tight group-hover:text-primary-700 transition-colors",
