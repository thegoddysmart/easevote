      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
          ...
          <div className="bg-linear-to-b from-secondary-50 to-white p-8 rounded-3xl border border-secondary-100 shadow-sm flex flex-col">
            ...
            <Link
              href="/sign-up"
              className="block w-full text-center py-3 rounded-xl bg-linear-to-r from-secondary-700 to-pink-500 text-white! font-bold hover:opacity-90 transition-opacity shadow-lg shadow-secondary-500/20"
            >
              Create Events
            </Link>
          </div>
